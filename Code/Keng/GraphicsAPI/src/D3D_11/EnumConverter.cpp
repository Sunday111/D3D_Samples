...
namespace keng::graphics_api::d3d
{
    ...
    D3D11_FILTER ConvertFilteringMode(FilteringMode from) {
        return CallAndRethrowM + [&] {
            switch (from) {
            case keng::graphics_api::FilteringMode::Nearest:     return D3D11_FILTER_MIN_MAG_MIP_POINT;
            case keng::graphics_api::FilteringMode::Bilinear:    return D3D11_FILTER_MIN_MAG_LINEAR_MIP_POINT;
            case keng::graphics_api::FilteringMode::Trilinear:   return D3D11_FILTER_MIN_MAG_MIP_LINEAR;
            case keng::graphics_api::FilteringMode::Anisotropic: return D3D11_FILTER_ANISOTROPIC;
