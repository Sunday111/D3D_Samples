...
namespace keng::graphics
{
    DepthStencil::DepthStencil(Device& device, const DepthStencilParameters& p) {
        CallAndRethrowM + [&] {
            ...
            m_dsv = m_texture->GetView<d3d_tools::ResourceViewType::DepthStencil>(m_device->GetDevice(), p.format);
        };
    }
    ...
    core::Ptr<TextureView<d3d_tools::ResourceViewType::DepthStencil>> DepthStencil::GetView() const {
        return m_dsv;
    }
}
